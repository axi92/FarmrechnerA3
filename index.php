...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de"><head>
    ...
    <script language="javascript"><!--
		var produkte = [ 
			['Kupfererz','Kupfer',1232,4,3],
			['Eisenerz','Eisen',2408,5,3],
			['Stein','Zement',1428,6,5],
			['Salz','Raffiniertes Salz',1176,3,1],
			['Trauben','Wein',1176,3,2],
			...
			['Cannabis','Marijuana',3773,4,3],
			['Heroin','Reines Heroin',3696,6,4],
			['Kokain','Reines Kokain',5852,6,4],
			['Dunkle Materie','Dunkle Materie',38000,100,100],
			['Brief','Brief',392,3,3],
			['Paket','Paket',6160,25,25],
			['Schildkröte','Schildkröte',8800,6,6],
			['Tunfisch','Tunfisch',4455,6,6],
			['Ornate','Ornate',378,2,2],
			['Salema','Salema',505,2,2],
			['Makrele','Makrele',600,4,4],
			['Mullet','Mullet',705,4,4],
			['Katzenhai','Katzenhai',835,6,6],
			['Apfel','Apfel',50,1,1],
