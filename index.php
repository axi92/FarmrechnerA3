...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de"><head>
    ...
    <script language="javascript"><!--
		...
		var vehicle = [
			['Kein Fahrzeug',0,0,0],
			['Limousine',24000,0,52],
			['Geländewagen',36000,0,108],
			['Truck',97500,0,200],
			['SUV',135000,0,80],
			['Truck Boxer',127500,0,208],
			['Tanklaster',127500,0,260],
			['Limousine (Sport)',180000,0,65],
			['Zamak-Transporter',351000,0,320],
			['Zamak-Transporter (abgedeckt)',468000,0,440],
			['Zamak Tanken',4680000,0,440],
			...
			['Rettungsboot',7500,0,145],
			['Rettungsboot',22500,0,330],
			['Motorboot',45000,0,400]
			];
